...
- (void)viewDidLoad {
    [super viewDidLoad];    
    self.title = @"주일설교";
    self.allEntries = [NSMutableArray array];    self.queue = [[[NSOperationQueue alloc] init] autorelease];
    
    self.feeds = [NSArray arrayWithObjects:@"feed://gdata.youtube.com/feeds/base/users/vicol0church/uploads",
                  nil];    
    [self refresh];
}
